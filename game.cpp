                                ...
                                while(SDL_PollEvent(&e)){
                                    ...
                                    if(e.type == SDL_MOUSEBUTTONDOWN || e.type == SDL_MOUSEMOTION){
                                        if(e.button.button == SDL_BUTTON_LEFT){
                                            ...
                                            if((flag || (my >= sliderBar.y - 10 && my <= sliderBar.y + sliderBar.h + 10))
                                             && mx >= sliderBar.x && mx <= sliderBar.x + sliderBar.w && !flag2) {
                                                volume = (mx - sliderBar.x) * 128 / sliderBar.w;
                                                Mix_VolumeMusic(volume); Mix_Volume(-1, volume);
                                                sliderKnob.x = mx - 5; flag = 1;
                                            }

                                            if((flag2 || (my >= sliderBar2.y - 10 && my <= sliderBar2.y + sliderBar2.h + 10))
                                             && mx >= sliderBar2.x && mx <= sliderBar2.x + sliderBar2.w && !flag) {
